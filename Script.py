class script(object):   
    ...
    ABOUT_TXT = """➾ 𝙼𝚈 𝙽𝙰𝙼𝙴 : <b>{}</b>
➾ 𝐋𝐢𝐛𝐫𝐚𝐫𝐲 : 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼𝙴
➾ 𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞 : 𝙿𝚈𝚃𝙷𝙾𝙽3
➾ 𝐁𝐨𝐭 𝐒𝐞𝐫𝐯𝐞𝐫 : <a href=https://t.me/Nokkiirunnoippolkittum>𝙵𝚁𝙴𝙴 𝚅𝙿𝚂</a>
➾ 𝐃𝐚𝐭𝐚𝐁𝐚𝐬𝐞 : 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱"""

    SOURCE_TXT = """<b>NOTE:</b>
- 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 : <a href=https://t.me/Nokkiirunnoippolkittum>𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞</a>"""
...
⪼ 𝐄𝐱𝐚𝐦𝐩𝐥𝐞 ›
<code>/batch https://t.me/MSM_Updates https://t.me/MSM_Updates</code>"""
    
    MANUELFILTER_TXT = """Help: <b>Filters</b>
- Filter is the feature were users can set automated replies for a particular keyword and ʙᴀᴇ  will respond whenever a keyword is found the message
<b>NOTE:</b>
...
◉ /purge :- Delete All Messages From The Replied To Message, To The Current Message"""
    ...
    ADMIN_REQUIRED = """❗<b>എന്നെ Admin ആക്കത്ത സ്ഥലത്ത് ഞാൻ നിക്കില്ല പോകുവാ Bye..Add Me Again with all admin rights.</b>"""
